...
#pragma endregion
	...
	// 1頂点当たりのサイズ
	vertexBufferView.StrideInBytes = sizeof(VertexDate); // 1頂点当たりのサイズ
	// 頂点リソースにデータを書き込む
	VertexDate* vertexDate = nullptr;
	// 書き込むためのアドレスを取得
	vertexResource->Map(0, nullptr, reinterpret_cast<void**>(&vertexDate));
	std::memcpy(vertexDate, modelData.vertices.data(), sizeof(VertexDate)* modelData.vertices.size()); // 頂点データをリソースにコピー
